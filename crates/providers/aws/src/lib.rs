//! AWS cloud provider scaffold — implement in a future state.
//!
...
//! not a partial implementation: it compiles and lets the control plane list AWS as
...
/// AWS provider scaffold. See the module docs.
...
mod tests {
    ...
    async fn capabilities_are_empty() {
        assert_eq!(AwsProvider.capabilities(), Capabilities::none());
    }
