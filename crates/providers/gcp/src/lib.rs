//! GCP cloud provider scaffold — implement in a future state.
//!
...
//! not a partial implementation: it compiles and lets the control plane list GCP as
...
/// GCP provider scaffold. See the module docs.
...
mod tests {
    ...
    async fn capabilities_are_empty() {
        assert_eq!(GcpProvider.capabilities(), Capabilities::none());
    }
